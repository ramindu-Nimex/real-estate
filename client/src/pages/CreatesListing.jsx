...
export default function CreatesListing() {
  ...
  return (
    <main className='p-3 max-w-4xl mx-auto'>
      ...
      <form  action="" className='flex flex-col sm:flex-row gap-4'>
         ...
         <button onClick={handleSubmit} disabled={loading || uploading} className="p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80">{loading ? 'CREATING...' : 'CREATE LISTING'}</button>
